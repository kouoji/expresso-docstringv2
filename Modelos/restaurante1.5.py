...
#restaurante_praca=Restaurante('centro','Porções')
#restaurante_praca.nome='Centro'
#restaurante_praca.categoria='Porções'
restaurante_pizza=Restaurante()
#3Consumindo os objetos criado

#restaurante=[restaurante_praca,restaurante_frutos]
